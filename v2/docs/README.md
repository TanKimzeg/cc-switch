...
3. 按需查阅 [commands-api.md](commands-api.md) / [frontend-api.md](frontend-api.md) / [data-model.md](data-model.md)
4. 写 TS 插件前必读 [ts-plugin.md](ts-plugin.md)
5. 规划功能补齐时参考 [v1-gap-analysis.md](v1-gap-analysis.md)
